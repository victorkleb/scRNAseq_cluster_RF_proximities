...
################################################################################################################################ 
##                                                                                                                            ##
##  start program: gene_clusters__individual_and_consensus.py                                                                 ##
##                                                                                                                            ## 
################################################################################################################################
#
#  invoke FUNCTION  gene_clusters__individual_and_consensus
#
################################################################################################################################
...
####  log output
logfile_dsn  =  trees_data_path /  "gene_clusters__individual_and_consensus.txt"
...
result_list =  gene_clusters__individual_and_consensus  ( 20, trees_data_path )
...
################################################################################################################################ 
##                                                                                                                            ##
##  end program: gene_clusters__individual_and_consensus.py                                                                   ## 
##                                                                                                                            ## 
################################################################################################################################
################################################################################################################################
