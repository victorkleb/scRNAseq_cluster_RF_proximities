...
#######################################################################################################
#                                                                                                     #   
#  start program  plot_MME_vs_cell_silhouette_scores_from_mean_proximities_drop_outliers.py           #
#                                                                                                     #  
#######################################################################################################
...
for clusters in  df_cell_silhouette_scores_all.columns.values.tolist(): 
  ...
  title2 = 'Mean Misclassification Error for ' + str ( clusters ) + ' individual clusters vs Silhouette score'
...
#######################################################################################################
#                                                                                                     #   
#  end   program  plot_MME_vs_cell_silhouette_scores_from_mean_proximities_drop_outliers.py           #
#                                                                                                     #  
#######################################################################################################
#######################################################################################################
